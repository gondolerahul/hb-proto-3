...
<Response>
    ...
    # 3. Generate WebSocket URL for streaming
...
async def twilio_status_callback(
    ...
    logger.info(f"Twilio status callback: {call_sid} status={call_status} duration={call_duration}")
...
async def whatsapp_incoming_message(
    ...
    """
    from src.streaming.whatsapp_handler import WhatsAppHandler
