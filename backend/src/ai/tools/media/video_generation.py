...
class VideoGenerationTool(Tool):
    ...
    # High per-call cost; opt-in per company via
    # tools.experimental.video_generation feature flag.
    from src.ai.tools.base import ToolStatus as _TS
    status = _TS.EXPERIMENTAL
    del _TS
    description = (
