...
Configuration via environment variables:
    ...
    SeedEntities/SeedDocumentFactory/scripts/ directory.
"""
...
def _resolve_shared_dirs() -> list[tuple[str, str]]:
    ...
    # 2. Auto-detect: look for SeedDocumentFactory/scripts relative to project root
    if not result:
        ...
        scripts_dir = project_root / "SeedEntities" / "SeedDocumentFactory" / "scripts"
