"""solo_pack/templates/acquisition — the P03 Cold-to-Closed slice (Growth).

The four templates the SLICE authored and proved end-to-end: the email gateway
that turns inbound mail into a Lead, the acquisition Process that owns
Lead/Opportunity/Quote, and the two workforce agents that qualify and quote.
Unchanged from the shipped slice — moved here so PACK's per-domain modules sit
beside it and ``__init__`` is a pure aggregator.
"""
...
__all__ = [
    "KAR_02_EMAIL", "P03_ACQUISITION", "AGT_013", "AGT_015", "ACQUISITION_TEMPLATES",
]
...
ACQUISITION_TEMPLATES: list[dict[str, Any]] = [
    KAR_02_EMAIL, P03_ACQUISITION, AGT_013, AGT_015,
]
