...
# The shared outward gateways (feed every process). KAR-02 is built; KAR-01
# (voice stub) and KAR-03 (WhatsApp) join in the KAR workstream.
GATEWAYS: list[dict[str, Any]] = [KAR_02_EMAIL]
