...
from src.ai.memory.dreaming_prompts import (
...
class DreamingEngine:
    ...
    async def _extract_observations(self, entity_id: UUID) -> List[UUID]:
        ...
        episodic_svc = EpisodicTreeService(self.db, self.company_id)
        ...
        embedding_svc = EmbeddingService(self.db, self.company_id)
        ...
        for obs in observations:
            ...
            await embedding_svc.embed_node(node)
    ...
    async def _distill_intelligence(self, entity_id: UUID) -> List[UUID]:
        ...
        experience_svc = ExperienceTreeService(self.db, self.company_id)
        intelligence_svc = IntelligenceTreeService(self.db, self.company_id)
