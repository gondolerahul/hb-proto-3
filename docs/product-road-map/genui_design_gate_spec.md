...
## 11. Art Direction (the visual bible's brief) — ⚠️ SUPERSEDED 2026-07-28

> **This section is history.** The **Buddha Cognitive Lab design system** landed in the repo on 2026-07-28, and Increment-7 charter **decision 2** made it canonical across all three renderers. The live art direction is **[increment-7/03_art_bible.md](./increment-7/03_art_bible.md)**; specimens in [increment-7/art-bible/specimens.html](./increment-7/art-bible/specimens.html).
>
> **Retired by that decision**, named so nobody rediscovers them as a bug: the parchment daylight ground, the deep-indigo night ground, the walnut/brass/paper/linen interiors, and the narrative serif. The product is a warm near-black canvas (`#0a0908`) with a single gold (`#edab48`), Space Grotesk / Hanken Grotesk / JetBrains Mono, and the brand's liquid-glass material.
>
> **Carried forward unchanged:** living day–night (concepts §6.7) — preserved in substance as a **luminance** shift rather than a palette swap (charter decision 3); L6's material distinction between real and twin — solved by **desaturation**, which introduces no second hue and cannot be forged, since the renderer applies it at the plane boundary; L7's stylized, disclosed, never-photoreal portraits — strengthened, because the proposed halftone-dot medium carries the disclosure in the artwork itself; inertial, silent, fully-removable motion; and *colour never carries meaning alone*, which a one-hue palette makes more load-bearing, not less.
>
> The original text follows, struck through in intent if not in markup.
...
- **The Glasshouse:** silvered glass and cool light — identical layouts to the real side, different physics of light (L6). Gold only for the divergence ribbon and certified seals. *(Intent intact; the mechanism is now desaturation — art bible §5.)*
...
| Date | Change |
|---|---|
| 2026-07-28 | v1.4 — **§11 superseded.** The Buddha Cognitive Lab design system landed in the repo and Increment-7 charter decision 2 made it canonical across all three renderers, retiring §11's parchment daylight, indigo night, walnut-brass-linen interiors and narrative serif. Living day–night survives as a **luminance** shift (charter decision 3) and L6's real-vs-twin distinction as **desaturation** — no second hue, and unforgeable because the renderer applies it at the plane boundary. The live art direction is [increment-7/03_art_bible.md](./increment-7/03_art_bible.md), whose load-bearing content is a **gold budget** (gold means *this needs you* or *this is certified*, nothing else) — which is what lets a still estate be visibly still under a single-accent palette. No law, depth level, ontology row or surface changes. |
