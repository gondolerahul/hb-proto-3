...
| **R-3b** ◐ | **All eighteen surfaces drawn** — owner review round 1 implemented (A1–A4, B, C, D), then the Glasshouse, Undercroft, Library, Bridges & Gates, Talent Office and Gallery. See [02](./02_prototype_r3a.md) §5a–§5d | **Owner review**, D4's gate |
