...
> **Created:** 2026-07-24 · **Status:** v1.2 — decisions locked; all six workstream docs written; **LEARN complete (T1–T10)**, **SEGA T0–T2 built** (2026-07-25).
...
| 2 | **SEGA** — self-evolution GA, entity-change canary, version ledger, taint | **B11**, **D3** | [02_sega.md](./02_sega.md) — **T0–T2 built** |
...
Baseline to beat (as of 2026-07-25, after LEARN + SEGA T0–T2): typecheck **276 files**, **1691 unit**, **16 parity/eval**, **341 integration**, migration head **`sega001`**. *(The Inc-5 baseline this row started from was 260 / 1550 / 16 / 288 / `fleet001`.)*
